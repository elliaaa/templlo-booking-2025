...
import static com.templlo.service.common.security.GlobalConst.*;
...
public class CustomAuthenticationFilter extends OncePerRequestFilter {
	...
	private void checkUserInfoValid(String userId, String userRole, String usedAuthToken) {
		if (userId == null || userRole == null || userId.isBlank() || userRole.isBlank() || usedAuthToken == null
			|| usedAuthToken.isBlank()) {
